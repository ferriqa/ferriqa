...
describe("RBAC Permissions", () => {
  describe("hasPermission", () => {
    ...
    it("Editor role has expected permissions", () => {
    ...
    it("Editor role does not have restricted permissions", () => {
    ...
    it("Viewer role does not have write permissions", () => {
  ...
  describe("getRolePermissions", () => {
    it("Admin returns wildcard", () => {
      const permissions = getRolePermissions("admin");
      expect(permissions).toEqual(["*"]);
    });

    it("Editor returns expected permissions", () => {
    ...
    it("Viewer returns read-only permissions", () => {
  ...
  describe("Permission Matrix", () => {
    ...
    it("All permissions are defined in type", () => {
